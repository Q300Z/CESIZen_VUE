  ...
  >
    <template #prepend>
      <v-list>
        ...
        <v-list-item v-role="['user','admin']" link prepend-icon="mdi-emoticon-happy-outline" title="Tracker" to="/tracker"/>
      </v-list>
    </template>
  <template #append>
    <v-divider></v-divider>
    ...
    <v-list-item v-role="['admin']" link prepend-icon="mdi-account-group" title="Gestion utilisateurs" to="/admin/users"/>
      <v-list-item v-role="['admin']" link prepend-icon="mdi-format-list-text" title="Gestion articles" to="/admin/infos"/>
    </v-list>
  </template>
  </v-navigation-drawer>
</template>
