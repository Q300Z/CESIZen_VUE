    ...
    >
      <template #top>
        <v-toolbar flat>
          ...
          <v-spacer />
          <v-btn color="primary" to="/admin/emotions/base">Liste des émotions de base</v-btn>
          <v-btn color="primary" to="/admin/emotions/add">Ajouter une émotion</v-btn>
        </v-toolbar>
      </template>

      <template #item.actions="{ item }">
        <v-btn :to="`/admin/emotions/edit/${item.id}`" icon variant="text">
